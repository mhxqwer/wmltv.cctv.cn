...
//2020 两会专题页 首页 点播
if(location.href.indexOf("news.cctv.cn/special/2020lhspj") > -1){
...
if(location.href.indexOf("news.cctv.cn/special/2020lianghui/index.shtml") > -1 || location.href.indexOf("news.cctv.cn/special/2020lianghui/lianghuiminglan/bztd/index.shtml") > -1 || location.href.indexOf("news.cctv.cn/special/2020lianghui/lianghuiminglan/wytd/index.shtml") > -1 || location.href.indexOf("news.cctv.cn/special/2020lianghui/lianghuiminglan/dbtd/index.shtml") > -1){
	video_CHANNEL = '2020lhspj';
...
/*https://yayun.cctv.cn/2022/byydyy/index.shtml 亚运会专题页添加前贴片1联
 */
if(location.href.indexOf("yayun.cctv.cn/2022/byydyy") > -1){
...
if(channelId == "wlchunwan.cntv.cn"||location.href.split("/")[2]=="wlchunwan.cntv.cn" || location.href.split("/")[2]=="wlchunwan.cctv.com"){				//网络春晚
	...
	live_Ad_Pause = ""; //直播暂停
	live_Ad_Banner = ""; //悬浮banner
	if(location.href.indexOf("wlchunwan.cctv.cn/2020/zb")!=-1 || location.href.indexOf("wlchunwan.cctv.cn/2020/db")!=-1){
	...
	if(location.href.indexOf("wlchunwan.cctv.cn/2021/index")!=-1 || location.href.indexOf("wlchunwan.cctv.com")!=-1  || location.href.indexOf("wlchunwan.cctv.cn/2021")!=-1 || location.href.indexOf("wlchunwan.cctv.cn/wlchunwan2021/home_test")!=-1){  //2021 网络春晚
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=wlchunwan&_CHANNEL=wlchunwan2021";
	}
	if(location.href.indexOf("wlchunwan.cctv.cn/2022/index")!=-1 || location.href.indexOf("wlchunwan.cctv.com")!=-1  || location.href.indexOf("wlchunwan.cctv.cn/2022")!=-1 || location.href.indexOf("wlchunwan.cctv.cn/2022/home_test")!=-1){  //2022 网络春晚
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=wlchunwan&_CHANNEL=wlchunwan2022";
	}
	if(location.href.indexOf("wlchunwan.cctv.cn/2023/index")!=-1 || location.href.indexOf("wlchunwan.cctv.com")!=-1  || location.href.indexOf("wlchunwan.cctv.cn/2023")!=-1 || location.href.indexOf("wlchunwan.cctv.cn/2023/home_test")!=-1){  //2023 网络春晚
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=wlchunwan&_CHANNEL=wlchunwan2023";
	}
	if(location.href.indexOf("wlchunwan.cctv.cn/2024/index")!=-1 || location.href.indexOf("wlchunwan.cctv.com")!=-1  || location.href.indexOf("wlchunwan.cctv.cn/2024")!=-1 || location.href.indexOf("wlchunwan.cctv.cn/2024test")!=-1){  //2024 网络春晚
...
if(channelId == "2022.cctv.com"){//2022北京冬奥
	live_Ad_Calls ="";
	//if(location.href.indexOf("2022.cctv.cn/live/cctv5plus")!=-1 || location.href.indexOf("2022.cctv.cn/live/cctv5")!=-1){
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=2022.cctv.com&_CHANNEL="+rel_url;
	//}
	if(location.href.indexOf("2022.cctv.cn/live/daka")!=-1 || location.href.indexOf("2022.cctv.cn/live/yiqikandongao")!=-1){
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=2022.cctv.com&_CHANNEL="+rel_url;
	}
...
if(channelId == "2020.cctv.com"){ //东京奥运会
	...
	if(getCookie("verifycode")){
		var jsload = document.createElement("script");
			jsload.src = "//r.img.cntv.cn/photoAlbum/templet/common/DEPA1567070010882321/sha256.js";
	...
	function getToken(sign) {
		$.ajax({
			type: "post",
			url: "https://vipapi.app.cctv.cn/cmos-facade-server/openapi/token/generate",
			dataType: "json",
	...
	function getVip(token,sign){
		$.ajax({
			type: "post",
			url: 'https://vipapi.app.cctv.cn/cmos-facade-server/api/memberInfo/memberDetailInfo',
			dataType: "json",
			contentType: "application/json",
			data: JSON.stringify({
				"params": {
...
if(channelId == "chunwan.cctv.com" || location.href.split("/")[2]=="chunwan.cctv.com"){ //2021年春晚广告
	...
	/*if(location.href.indexOf("chunwan.cctv.cn/2021/livetest")!=-1 || location.href.indexOf("chunwan.cctv.cn/2021/live")!=-1){ //2021年春晚广告
	...
	if(location.href.indexOf("chunwan.cctv.cn/2021/dianbotest")!=-1 || location.href.indexOf("chunwan.cctv.cn/2021/dianbo")!=-1){ //2021年春晚广告
		ad_Calls = ad_dq_1+"&_page_group=dianbo&_subsite=chunwan&_CHANNEL=2021chunwan";
		ad_Call_h5 = ad_dq_hb1+"&_page_group=dianbo&_subsite=chunwan&_CHANNEL=2021chunwan";
	}

	if(location.href.indexOf("chunwan.cctv.cn/2021/quanjingsheng")!=-1){ //2021年春晚广告
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=chunwan&_CHANNEL=2021chunwan";
		ad_Calls = ad_dq_1+"&_page_group=dianbo&_subsite=chunwan&_CHANNEL=2021chunwan";
		ad_Call_h5 = ad_dq_hb1+"&_page_group=dianbo&_subsite=chunwan&_CHANNEL=2021chunwan";
	}*/
	if(location.href.indexOf("chunwan.cctv.cn/2024/livetest")!=-1 || location.href.indexOf("chunwan.cctv.cn/2024/live")!=-1){ //2024年春晚广告
	...
	if(location.href.indexOf("chunwan.cctv.cn/2024/dianbotest")!=-1 || location.href.indexOf("chunwan.cctv.cn/2024/dianbo")!=-1){ //2024年春晚广告
		ad_Calls = ad_dq_1+"&_page_group=dianbo&_subsite=chunwan&_CHANNEL=2024chunwan";
		ad_Call_h5 = ad_dq_hb1+"&_page_group=dianbo&_subsite=chunwan&_CHANNEL=2024chunwan";
	}
	if(location.href.indexOf("chunwan.cctv.cn/2024/testvideo")!=-1){ //2024测试春晚广告
	...
	if(location.href.indexOf("chunwan.cctv.cn/2024/yxwh/livetest")!=-1 || location.href.indexOf("chunwan.cctv.cn/2024/yxwh/live")!=-1){ //2024年元宵
		live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=chunwan&_CHANNEL="+zhibo;
		
	}

	/*if(location.href.indexOf("chunwan.cctv.cn/2023/quanjingsheng")!=-1){ //2021年春晚广告
...
if(location.href.indexOf("jishi.cctv.cn/special")!=-1){
...
if(location.href.indexOf("tv.cctv.cn/lm/dzw/jcsp")!=-1 || location.href.indexOf("tv.cctv.cn/lm/jxll3")!=-1 || location.href.indexOf("tv.cctv.cn/lm/yjdk")!=-1 || location.href.indexOf("tv.cctv.cn/lm/wmhl")!=-1 || location.href.indexOf("tv.cctv.cn/lm/szsxy")!=-1 || location.href.indexOf("tv.cctv.cn/lm/csjd")!=-1 || location.href.indexOf("tv.cctv.cn/lm/jjbxs")!=-1 || location.href.indexOf("tv.cctv.cn/lm/yscjpl")!=-1 || location.href.indexOf("tv.cctv.cn/lm/xwdc")!=-1 || location.href.indexOf("tv.cctv.cn/lm/duihua")!=-1 || location.href.indexOf("tv.cctv.cn/lm/xunbao")!=-1 || location.href.indexOf("tv.cctv.cn/lm/jjxxll/")!=-1 || location.href.indexOf("tv.cctv.cn/lm/hjcf/")!=-1 || location.href.indexOf("tv.cctv.cn/lm/tbcx/")!=-1 || location.href.indexOf("tv.cctv.cn/lm/cyyxh/")!=-1||location.href.indexOf("tv.cctv.cn/lm/zcjkk/")!=-1){				//cctv.cntv.cn 栏目
   ...
   //+ "{!@#}" + ad_dq_2+ad_cond;
	...
	if(location.href.indexOf("tv.cctv.cn/lm/yscjpl")!=-1 || location.href.indexOf("tv.cctv.cn/lm/yjdk")!=-1 ||location.href.indexOf("tv.cctv.cn/lm/tbcx/")!=-1 ||location.href.indexOf("tv.cctv.cn/lm/zcjkk/")!=-1||location.href.indexOf("tv.cctv.cn/lm/cyyxh/")!=-1){
		ad_Calls = ad_dq_1+ad_cond;
		ad_After = '';
		ad_Pause = '';
		ad_Banner = '';
	...
	//1227 新增
	if(location.href.indexOf("tv.cctv.cn/lm/dzw/jcsp")!=-1 || location.href.indexOf("tv.cctv.cn/lm/jxll3")!=-1 || location.href.indexOf("tv.cctv.cn/lm/wmhl")!=-1 || location.href.indexOf("tv.cctv.cn/lm/szsxy")!=-1 || location.href.indexOf("tv.cctv.cn/lm/csjd")!=-1 || location.href.indexOf("tv.cctv.cn/lm/jjbxs")!=-1 ){
		//20200304点播通用前贴片广告位 改为两联
		ad_Calls = ad_dq_1+ad_cond;
		//+ "{!@#}" + ad_dq_2+ad_cond;
		// + "{!@#}" + ad_dq_3+ad_cond
...
/* tv 专题 */
if(location.href.indexOf("tv.cctv.cn/special")!=-1){
	var specialUrl = location.href.split("/")[4];
...
if(location.href.indexOf("tv.cctv.cn/lm")!=-1){ //栏目直播
...
if(location.href.indexOf("sports.cctv.cn/live")!=-1){ //2023体育直播
	live_Ad_Calls = ad_zq_hb1+"&_page_group=zhibo&_subsite=sports.cctv.com&_CHANNEL="+livechannelLive; //只要前贴片1
	live_Ad_Pause = ""; //暂停
	live_Ad_Banner = ""; //悬浮banner
}

if(location.href.indexOf("tv.cctv.cn/live")!=-1){					//http://tv.cctv.com 栏目直播页
	var channelTv = rel_url;
	//var channelTv = '20170607test';
	if(location.href.indexOf("tv.cctv.cn/live/cctvxiyu")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvxiyu/sd")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvfrench")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvfrench/sd")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvarabic")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvarabic/sd")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvrussian")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvrussian/sd")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctveurope")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctveurope/sd")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvamerica")!=-1 || location.href.indexOf("tv.cctv.cn/live/cctvamerica/sd")!=-1){	
	}else{
		//20200327 直播前贴改为一联
...
if(location.href.indexOf("tv.cctv.cn/cctv3")!=-1){					//CCTV3
	video_CHANNEL="";
	if(location.href.indexOf("tv.cctv.cn/cctv3/special/2017wjymy")!=-1){//2017万家邀明月中秋特别节目
		video_CHANNEL = "2017wjymy";
	}
	if(location.href.indexOf("tv.cctv.cn/cctv3/special/2017cyj")!=-1){//2017-CCTV3-九九艳阳天-重阳特别节目》
...
if(location.href.indexOf("dianshiju.cctv.cn/special/hjdjc/")!=-1){  //电视剧台专题
	ad_Calls = "";
	ad_After = "";
	ad_Pause = "";
	ad_Banner = "";
...
//2021中秋直播
if(location.href.indexOf("tv.cctv.cn/special/2021zqwh") > -1 || location.href.indexOf("yy.cms.cntv.cn/html/shenhe/PAGEfXpWN63LLyDsLDMHOVoq210914") > -1){
...
//2022中秋直播
if(location.href.indexOf("tv.cctv.cn/special/2022zqwh") > -1 || location.href.indexOf("yy.cms.cntv.cn/html/shenhe/PAGEvB601Gvq91k2pvjXh3RL220819") > -1){
	live_Ad_Calls = "";
	ad_Calls = "";
	ad_After = "";
	ad_Pause = "";
...
//2023中秋直播
if(location.href.indexOf("tv.cctv.cn/special/2023zqwh") > -1 || location.href.indexOf("yy.cms.cntv.cn/html/shenhe/PAGEZnrkESmW9Z3J3348C7CG230906") > -1){
...
if(location.href.indexOf("kejiao.cctv.cn/special/zmys")!=-1){		//科教台 > 2016年度—寻找最美医生 
	ad_Calls = "";
	ad_After = "";
	ad_Pause = "";
	ad_Banner = "";
...
if(location.href.indexOf("kejiao.cctv.cn/special/2017zmjs")!=-1){		//科教台 2017最美教师
	live_Ad_Calls = "";
	live_Ad_Pause = ""; //暂停
	live_Ad_Banner = ""; //悬浮banner
}
...
if ((referrerStr == 'www.cctv.com' || referrerStr == 'www.cctv.cn/' || referrerStr.indexOf("www.cctv.cn/index.shtml")!=-1) && isAdShow=='1'){
	//console.log("if");
	ad_Calls = '';
}
/*20220104审核页去除播放器广告*/
